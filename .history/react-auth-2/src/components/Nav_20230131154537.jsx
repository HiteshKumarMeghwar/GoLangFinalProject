          ...
          <div className="container flex flex-wrap items-center justify-between mx-auto">
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
              <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                {prop.userData && prop.userData.role_id === 1 && (
                    <>
                      <li>
                        <p>Admin</p>
                      </li>
                ...
                {prop.userData && prop.userData.role_id === 2 && (
                    <>
                      <li>
                        <p>Author</p>
                      </li>
                ...
                {prop.userData && prop.userData.role_id === 3 && (
                    <>
                      <li>
                        <p>Student</p>
                      </li>
                  ...
                  <>
                    <li>
                      <Link to="/profile" style={{color: "blue", fontFamily: "cursive", fontSize: "larger", fontWeight: "bold"}}>   
                        {prop.userData.first_name} {prop.userData.last_name}
                      </Link>
                    </li>
                    <li>
                      -
