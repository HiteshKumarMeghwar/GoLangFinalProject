                ...
                <form method='POST' className="mt-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-2">
                        ...
                        <select 
                            ...
                            className="block w-full px-4 py-2 mt-2 text-purple-700 bg-white border rounded-md focus:border-purple-400 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40"
                        >
                            <option value="1" {...userData?.role_id && admin} >Admin</option>
                            <option value="2" {...userData?.role_id && author} >Author</option>
                            <option value="3" {...userData?.role_id && student} >Student</option>
                        </select>
                    </div>
                    <div className="mt-6">
