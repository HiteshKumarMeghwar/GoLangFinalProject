...
function Home() {
  ...
  useEffect(() => {
    ...
    // Check if the user is logged in and the flag is not set
    if (isLoggedIn && !localStorage.getItem('isHomePageReloaded')) {
      // Reload the home page and set the flag in the localStorage
