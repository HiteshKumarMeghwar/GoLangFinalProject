        ...
        <div className="flex flex-col justify-center p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
                <div className="my-2 space-y-1">
                    ...
                    <p className="px-5 text-xs sm:text-base dark:text-gray-400">{userData?.email}</p>
                </div>
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <Link to={`/edit_profile/${userData?.id}`} className='flex items-center justify-center text-white px-8 py-3 border border-transparent rounded bg-indigo-600'>
                        Edit Profile
                    </Link>
                </div>
            </div>
