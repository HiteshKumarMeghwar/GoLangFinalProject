...
func TestCreatePost(t *testing.T) {
	...
	user := Blog{
		...
		Image:  "http://localhost:8080/api/upload/xvlbz_quotes-bckg.jpg",
		UserID: "19",
	}
...
func TestUpdatePost(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/api/updatepost/28", bytes.NewReader(userJson))
	req.Header.Set("Content-Type", "application/json")
	resp, err := app.Test(req, -1)
	if err != nil {
		t.Fatalf("Failed to send request: %v", err)
...
func TestUniquePosts(t *testing.T) {
	...
	// Make a POST request to register endpoint
	req := httptest.NewRequest(http.MethodPost, "/api/uniquepost", bytes.NewBufferString(`{"id": "19"}`))
	req.Header.Set("Content-Type", "application/json")
	resp, err := app.Test(req, -1)
	if err != nil {
		t.Fatalf("Failed to send request: %v", err)
...
func TestSendMail(t *testing.T) {
	...
	user := Mail{
		Name:    "try mail",
		Email:   "hk119892@gmail.com",
		Message: "testing by test cases",
	}
	...
	req := httptest.NewRequest(http.MethodPost, "/api/sendMail/18", bytes.NewReader(userJson))
	req.Header.Set("Content-Type", "application/json")
	resp, err := app.Test(req, -1)
	if err != nil {
		t.Fatalf("Failed to send request: %v", err)
...
func TestUpdateUser(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/api/updateUser/30", bytes.NewReader(userJson))
	req.Header.Set("Content-Type", "application/json")
	resp, err := app.Test(req, -1)
	if err != nil {
		t.Fatalf("Failed to send request: %v", err)
...
func TestDeleteUser(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodDelete, "/api/deleteUser/30", nil)
	req.Header.Set("Content-Type", "application/json")
	resp, err := app.Test(req, -1)
	if err != nil {
		t.Fatalf("Failed to send request: %v", err)
